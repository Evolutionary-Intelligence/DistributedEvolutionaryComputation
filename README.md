...
| Multidisciplinary Journals | [PNAS (Proceedings of the National Academy of Sciences)](https://www.pnas.org/) | EC | [www](https://github.com/Evolutionary-Intelligence/DistributedEvolutionaryComputation/blob/main/Proceedings-of-the-National-Academy-of-Sciences_PNAS.md)
...
| Journals for AI/ML | [JMLR (Journal of Machine Learning Research)](https://jmlr.csail.mit.edu/) | EC | [www](https://github.com/Evolutionary-Intelligence/DistributedEvolutionaryComputation/blob/main/Journal-of-Machine-Learning-Research_JMLR.md)
| Journals for AI/ML | [AIJ (Artificial Intelligence Journal)](https://www.sciencedirect.com/journal/artificial-intelligence) | EC | [www](https://github.com/Evolutionary-Intelligence/DistributedEvolutionaryComputation/blob/main/Artificial-Intelligence_AIJ.md)
| Journals for AI/ML | [IEEE-TPAMI (IEEE Transactions on Pattern Analysis and Machine Intelligence)](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=34) | EC | [www](https://github.com/Evolutionary-Intelligence/DistributedEvolutionaryComputation/blob/main/IEEE-Transactions-on-Pattern-Analysis-and-Machine-Intelligence_IEEE-TPAMI.md)
...
| Journals for AI/ML | [JAIR (Journal of Artificial Intelligence Research)](https://www.jair.org/index.php/jair/index) | EC | [www](https://github.com/Evolutionary-Intelligence/DistributedEvolutionaryComputation/blob/main/Journal-of-Artificial-Intelligence-Research_JAIR.md)
| Conferences for AI/ML | [ICLR (International Conference on Learning Representations)](https://iclr.cc/) | EC | [www](https://github.com/Evolutionary-Intelligence/DistributedEvolutionaryComputation/blob/main/International-Conference-on-Learning-Representations_ICLR.md)
...
| Journals for Neural Networks | [Neural Networks](https://www.sciencedirect.com/journal/neural-networks) | EC | [www](https://github.com/Evolutionary-Intelligence/DistributedEvolutionaryComputation/blob/main/Neural-Networks.md)
| Journals for Neural Networks | [IEEE-TNNLS (IEEE Transactions on Neural Networks and Learning Systems)](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=5962385) | EC | [www](https://github.com/Evolutionary-Intelligence/DistributedEvolutionaryComputation/blob/main/IEEE-Transactions-on-Neural-Networks-and-Learning-Systems_IEEE-TNNLS.md)
...
More *important* discussions of metaphor-based metaheuristics, see e.g., [Villalón et al., 2021](https://iridia.ulb.ac.be/IridiaTrSeries/rev/IridiaTr2021-006r001.pdf).

...
This is a *growing* paper list for [evolutionary computation (EC)](https://github.com/Evolutionary-Intelligence/DistributedEvolutionaryComputation/blob/main/Summary/EvolutionaryComputation.md). Currently we are **actively** updating it (at least from 2021 to 2024). Owing to the abundance of the related literature, however, we believe that many interesting works are still missed here. If you find them missed, welcome to contact with us via [Issues](https://github.com/Evolutionary-Intelligence/DistributedEvolutionaryComputation/issues) or [Pull requests](https://github.com/Evolutionary-Intelligence/DistributedEvolutionaryComputation/pulls) to add. Recently, we notice that some other research group(s) also starts to adopt a similar way to collect EC literatures, which is a good news.

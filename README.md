...
Although our initial goal was to cover only PDEC, now our focus is switched to **Evolutionary Computation (EC)** researches and applications for (>30) chosen journals and conferences besides EC-specific publications (e.g., [ECJ](https://direct.mit.edu/evco)/[IEEE-TEVC](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=4235)/ACM-TELO/ACM-FOGA/PPSN/ACM-GECCO/...). For EC-focused publications, currently still *only* Parallel/Distributed EC are covered.

...
Although our initial goal was to cover only PDEC, now our focus is switched to **Evolutionary Computation (EC)** researches and applications for (>30) chosen journals and conferences (such as [Nature](https://www.nature.com/), [Science](https://science.sciencemag.org/), [PNAS](https://www.pnas.org/), [PRL](https://journals.aps.org/prl/), [JACS](https://pubs.acs.org/journal/jacsat), [PIEEE](https://proceedingsoftheieee.ieee.org/), [Nature Materials](https://www.nature.com/nmat/), etc.) besides EC-specific publications (e.g., [ECJ](https://direct.mit.edu/evco)/[IEEE-TEVC](https://ieeexplore.ieee.org/xpl/RecentIssue.jsp?punumber=4235)/[ACM-TELO](https://dl.acm.org/journal/telo)/[ACM-FOGA](https://dl.acm.org/conference/foga)/[PPSN](https://link.springer.com/conference/ppsn)/ACM-GECCO/...). For EC-focused publications, currently still *only* Parallel/Distributed EC are covered.
